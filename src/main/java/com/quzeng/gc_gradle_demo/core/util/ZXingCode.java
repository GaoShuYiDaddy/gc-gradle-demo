...
public class ZXingCode {
    ...
    @Value("${QRCode_img_path}")
    static private String QRCODE_IMG_PATH;
...
//        File logoFile = new File("D://QrCode/A.png");
//        File QrCodeFile = new File(QRCODE_IMG_PATH + "100.png");
//        String url = "http://192.168.1.104:8080/pay/payCode/";
//        String note = "2018051532546";
//        System.out.println("1234");
//        drawLogoQRCode(logoFile, QrCodeFile, url+note, note);
//    }

    // 生成带logo的二维码图片    logoFile=logo路经   codeFile=图片路经   qrUrl=二维码内容  note=内容，自定义文本
